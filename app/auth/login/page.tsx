      ...
      <div className="min-h-screen flex flex-col items-center justify-center p-6 pt-24 relative z-10">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            <span className="text-blue-600 dark:text-blue-400">Welcome to </span>
            <span className="text-gray-900 dark:text-white">CareerPrep</span>
            <span className="text-blue-600 dark:text-blue-400"> AI</span>
          </h1>
          <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto leading-relaxed">
            Your AI-powered interview preparation platform. Sign in to continue mastering your interview skills with personalized practice sessions.
          </p>
        </motion.div>
