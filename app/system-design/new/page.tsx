...
import { ArrowLeft, Play, Clock, Sun, Moon } from "lucide-react"
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-xl font-semibold text-gray-900 dark:text-white">New System Design Session</h1>
                <p className="text-sm text-gray-600 dark:text-gray-400">Choose a duration and start</p>
              </div>
            </div>
            {/* Theme Toggle Button */}
            <Button
                    ...
                    >
                      <div className="text-left">
                        ...
                        <div className={`text-xs ${
                          ...
                          {d==="junior"?"Foundational":"senior"===d?"Advanced":"Intermediate"}
                        </div>
                      </div>
                    </Button>
                  )
